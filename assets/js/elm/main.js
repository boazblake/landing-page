	...
	},
	{
		...
		_0: A2(
			...
			},
			{
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('fa fa-3 fa-heart'),
						_1: {ctor: '[]'}
					},
					{ctor: '[]'}),
				_1: {ctor: '[]'}
		...
		_1: {
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Congrats ~  you have successfully subscribed'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
...
if (typeof _user$project$Main$main !== 'undefined') {
    _user$project$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Messages.Msg":{"args":[],"tags":{"HandleFormSubmit":[],"HandleFullNameInput":["String"],"HandleEmailInput":["String"]}}},"aliases":{},"message":"Messages.Msg"},"versions":{"elm":"0.18.0"}});
}
